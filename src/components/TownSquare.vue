...
.night-order {
  ...
  &.first span {
    right: 120%;
    background: linear-gradient(to right, $townsfolk 0%, #ffffffaa 20%);
    &:before {
      content: "First Night";
    }
    &:after {
  ...
  &.other span {
    left: 120%;
    background: linear-gradient(to right, $demon 0%, ffffffaa 20%);
    &:before {
  ...
  &.first em {
    left: -10%;
    background: linear-gradient(180deg, #fff 0%, $townsfolk 100%);
  }

  &.other em {
    right: -10%;
    background: linear-gradient(180deg, #fff 0%, $demon 100%);
  }
